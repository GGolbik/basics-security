...
public class ConfigSubjectAlternativeName : ConfigExtension
{
    ...
    /// </summary>
    public IList<ConfigOtherName>? OtherNames { get; set; }
    /// <summary>
    /// rfc822Name                      [1]     IA5String,
    ...
    /// ediPartyName                    [5]     EDIPartyName,
    /// </summary>
    public IList<ConfigEdiPartyName>? EdiPartyNames { get; set; }
    /// <summary>
    /// uniformResourceIdentifier       [6]     IA5String,
    /// </summary>
    ...
    public override X509Extension ToX509Extension()
    {
        ...
        foreach (var otherName in this.OtherNames ?? new List<ConfigOtherName>())
        {
        ...
        foreach (var ediPartyName in this.EdiPartyNames ?? new List<ConfigEdiPartyName>())
        {
            var vector = new Asn1EncodableVector();
