...
public class Config
{
    ...
    public X50xFileFormat? IssuerPrivateKeyFileFormat { get; set; }
    ...
    public X50xFileFormat? IssuerCertFileFormat { get; set; }
    ...
    public X50xFileFormat? IssuerStoreFileFormat { get; set; }
    ...
    public X50xFileFormat? StoreFileFormat { get; set; }
    ...
    public X50xFileFormat? PrivateKeyFileFormat { get; set; }

    public string? PublicKeyFile { get; set; }
    public X50xFileFormat? PublicKeyFileFormat { get; set; }
    ...
    public X50xFileFormat? CertFileFormat { get; set; }
    ...
    public X50xFileFormat? CsrFileFormat { get; set; }
    ...
    public X50xFileFormat? TransformFileFormat { get; set; }

    public string? CrlFile { get; set; }
    public X50xFileFormat? CrlFileFormat { get; set; }
